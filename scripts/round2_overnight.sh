...
CUDA_VISIBLE_DEVICES=1 python3.11 -m src.evaluate \
  --model /home/lamassunobackup/tdebnath/codeQB/models/qwen2.5-coder-7b \
...
CUDA_VISIBLE_DEVICES=1 python3.11 -m src.evaluate \
  --model /home/lamassunobackup/tdebnath/codeQB/models/qwen2.5-coder-7b \
  --adapter /home/lamassunobackup/tdebnath/codeQB/models/agentq-round2 \
  --test-set data/test_set.json --mode full_rewrite 2>&1 | tee -a /tmp/round2_overnight.log
